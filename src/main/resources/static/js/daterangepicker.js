...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['templates/resources/js/moment', 'jquery'], function (moment, jquery) {
        ...
        if (!jQuery) {
            jQuery = require('templates/resources/js/jquery');
            if (!jQuery.fn) jQuery.fn = {};
        }
        var moment = (typeof window != 'undefined' && typeof window.moment != 'undefined') ? window.moment : require('templates/resources/js/moment');
